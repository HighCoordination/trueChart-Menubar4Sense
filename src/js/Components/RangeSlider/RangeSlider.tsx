...
export class RangeSlider extends React.Component<IRangeSliderProps> {
	...
	renderSlider = () =>{
		...
		const {vertical, min, max, step, railStyle, trackStyle, handleStyle, dotStyle, activeDotStyle} = props;
		if(props.type === 'single'){
			...
			return (<Range {...{vertical, min, max, marks, step, railStyle, trackStyle, handleStyle, dotStyle, activeDotStyle, handle}}
						   defaultValue={props.defaultValues} allowCross={false} onAfterChange={this.onAfterChange}/>);
		}
	};
